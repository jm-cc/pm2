...
#---------------------------------------------------------------------
tags:
	$(CTAGS) --recurse=yes --exclude=build --exclude=modules --exclude=SCCS --exclude=BitKeeper --exclude=ChangeSet --exclude=mad3 -I DEF_MARCEL,DEF_POSIX,DEF_MARCEL_POSIX,DEF_PTHREAD+,DEF___PTHREAD+,DEF_LIBPTHREAD+,DEF___LIBPTHREAD+,DEF_ALIAS_POSIX+,DEF_STRONG_T+,DEF_C+,DEF_LIBC+,DEF___C+,DEF___LIBC+ .
	$(ETAGS) --recurse=yes --exclude=build --exclude=modules --exclude=SCCS --exclude=BitKeeper --exclude=ChangeSet --exclude=mad3 -I DEF_MARCEL,DEF_POSIX,DEF_MARCEL_POSIX,DEF_PTHREAD+,DEF___PTHREAD+,DEF_LIBPTHREAD+,DEF___LIBPTHREAD+,DEF_ALIAS_POSIX+,DEF_STRONG_T+,DEF_C+,DEF_LIBC+,DEF___C+,DEF___LIBC+ .
