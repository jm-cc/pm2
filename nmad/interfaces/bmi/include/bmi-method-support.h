...
struct method_op
{
    /* be carefull while modifying this structure: op_id should remains the first field! (yeah I know, it's crappy */
    /* todo: use the struct_up trick */
    ...
    struct tbx_fast_list_head op_list_entry;	/* op_list link */
    struct tbx_fast_list_head hash_link;	/* hash table link */
