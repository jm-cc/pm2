...
#define MARCEL_BUBBLE_INITIALIZER(b) {					\
      .as_entity = MA_SCHED_ENTITY_INITIALIZER((b).as_entity, MA_BUBBLE_ENTITY, MA_DEF_PRIO, "root_bubble_e"), \
      .as_holder = MA_HOLDER_INITIALIZER((b).as_holder, MA_BUBBLE_HOLDER, "root_bubble_h"), \
...
/** Lazily bring the task \e task inside the bubble \e bubble by
 * setting its sched_holder and natural_holder accordingly. */
 ...
 * if not found.  */
extern const marcel_bubble_sched_class_t *marcel_lookup_bubble_scheduler_class(const char
									       *name);
 ...
 * found.  */
extern const marcel_bubble_sched_t *marcel_lookup_bubble_scheduler(const char *name);
 ...
 * internal view
 */
static __tbx_inline__ void __ma_bubble_enqueue_entity(marcel_entity_t * e,
						      marcel_bubble_t * b);
static __tbx_inline__ void __ma_bubble_dequeue_entity(marcel_entity_t * e,
						      marcel_bubble_t * b);

/* enqueue entity \e e in bubble \b, which must be locked, and may temporarily be unlocked */
static __tbx_inline__ void ma_bubble_enqueue_entity(marcel_entity_t * e,
						    marcel_bubble_t * b);
...
static __tbx_inline__ void ma_bubble_dequeue_entity(marcel_entity_t * e,
						    marcel_bubble_t * b);
...
/** \brief Force the running threads of a given locked bubble \b to be rescheduled. */
void __ma_resched_bubble_contents(marcel_bubble_t * b);
/** \brief Force the running threads of a given unlocked bubble \b to be rescheduled. */
