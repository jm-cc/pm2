...
extern void ma_open_softirq(int nr, void (*action)(struct ma_softirq_action*), void *data);
...
#section marcel_functions
extern void ma_tasklet_kill(struct ma_tasklet_struct *t);
extern void tasklet_kill_immediate(struct ma_tasklet_struct *t, ma_lwp_t lwp);
extern void ma_tasklet_init(struct ma_tasklet_struct *t,
