...
#define MARCEL_WORK_INIT ((marcel_work_t) {	\
	.has_work = 0,	                        \
        .deviate_work = NULL,			\
	.deviate_lock = MA_SPIN_LOCK_UNLOCKED	\
})
...
#define HAS_DEVIATE_WORK(pid)  ((pid)->work.has_work & MARCEL_WORK_DEVIATE)
#define SET_DEVIATE_WORK(pid)  do { (pid)->work.has_work |= MARCEL_WORK_DEVIATE; } while(0)
#define CLR_DEVIATE_WORK(pid)  do { (pid)->work.has_work &= ~MARCEL_WORK_DEVIATE; } while(0)
