...
eval _PM2CONFIG_MAKEFILE='$'_PM2CONFIG_${LIBRARY}_MAKEFILE
...
LIB_PM2_SHLIBS := $_PM2CONFIG_PM2_SHLIBS
LINK_LD_FLAGS := $_PM2CONFIG_LIBS
...
APP_CFLAGS += $_PM2CONFIG_appli_KERNEL_CFLAGS
