...
DEC_MARCEL(int, attr_getstacksize,
	   (__const marcel_attr_t * __restrict attr, size_t * __restrict stack) __THROW);
DEC_MARCEL(int, attr_setstackaddr, (marcel_attr_t * attr, void *addr) __THROW);
DEC_MARCEL(int, attr_getstackaddr,
	   (__const marcel_attr_t * __restrict attr, void **__restrict addr) __THROW);
DEC_MARCEL(int, attr_setstack,
	   (marcel_attr_t * attr, void *stackaddr, size_t stacksize) __THROW);
DEC_MARCEL(int, attr_getstack,
	   (__const marcel_attr_t * __restrict attr, void **__restrict stackaddr,
	    size_t * __restrict stacksize) __THROW);
DEC_MARCEL(int, attr_setdetachstate, (marcel_attr_t * attr, int detached) __THROW);
DEC_MARCEL(int, attr_getdetachstate,
	   (__const marcel_attr_t * attr, int *detached) __THROW);
