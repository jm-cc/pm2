...
PM2_NMAD_COMPONENTS="$PM2_NMAD_COMPONENTS NewMad_ibverbs_bycopy NewMad_ibverbs_rcache NewMad_ibverbs_adaptrdma NewMad_ibverbs_regrdma NewMad_ibverbs_auto"
