...
\date{\footnotesize%
\url{$Id: start.tex,v 1.2 2001/04/02 12:23:45 bouge Exp $}%
}
...
\begin{shell}
ravel% less ${HOME}/.pm2/flavors/${PM2_FLAVOR}
\end{shell}
...
\begin{shell}
ravel% setenv PM2_BUILD_DIR ${PM2_ROOT}/build
\end{shell}
