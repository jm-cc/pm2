...
#ifndef __SYS_MARCEL_CONTAINER_H__
#define __SYS_MARCEL_CONTAINER_H__
...
static inline int ma_container_nb_element(ma_container_t * container);
static inline int ma_container_is_full(ma_container_t * container);
static inline void ma_lock_container(ma_container_t * container);
static inline void ma_unlock_container(ma_container_t * container);
...
#endif /** __SYS_MARCEL_CONTAINER_H__ **/
