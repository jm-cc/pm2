...
static const struct mpi_bench_param_bounds_s*mpi_bench_rmaoverlap_put_target_getparams(void)
{
  return &param_bounds;
}

static void mpi_bench_rmaoverlap_put_target_setparam(int param)
{
  compute = param;
}

static void mpi_bench_rmaoverlap_put_target_server(void*buf, size_t len)
{
...
static void mpi_bench_rmaoverlap_put_target_init(void*buf, size_t len)
{
...
static void mpi_bench_rmaoverlap_put_target_finalize(void)
{
...
const struct mpi_bench_s mpi_bench_rmaoverlap_put_target =
  {
    ...
    .finalize  = &mpi_bench_rmaoverlap_put_target_finalize,
    .setparam  = &mpi_bench_rmaoverlap_put_target_setparam,
    .getparams = &mpi_bench_rmaoverlap_put_target_getparams
  };
