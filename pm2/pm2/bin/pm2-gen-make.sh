...
if [ -z "$PM2_CONFIG_SOURCEABLE" ]; then
    _PM2CONFIG_LIB_DIR=`$PM2_CONFIG --libdir $LIBRARY`
    _PM2CONFIG_OBJ_DIR=`$PM2_CONFIG --objdir $LIBRARY`
    _PM2CONFIG_CPP_DIR=`$PM2_CONFIG --cppdir $LIBRARY`
    _PM2CONFIG_ASM_DIR=`$PM2_CONFIG --asmdir $LIBRARY`
    _PM2CONFIG_DEP_DIR=`$PM2_CONFIG --depdir $LIBRARY`
    _PM2CONFIG_BIN_DIR=`$PM2_CONFIG --bindir $LIBRARY`
    _PM2CONFIG_TMP_DIR=`$PM2_CONFIG --tmpdir $LIBRARY`
    _PM2CONFIG_SRC_DIR=`$PM2_CONFIG --srcdir $LIBRARY`
    _PM2CONFIG_INCLUDE_DIR=`$PM2_CONFIG --includedir $LIBRARY`
    _PM2CONFIG_STAMP_DIR=`$PM2_CONFIG --stampdir`
    _PM2CONFIG_FLAVOR_STAMP_FILE=`$PM2_CONFIG --stampfile`
    _PM2CONFIG_EXT=`$PM2_CONFIG --ext`
    _PM2CONFIG_KERNEL_CFLAGS=`$PM2_CONFIG --kernel --cflags $LIBRARY`
    _PM2CONFIG_CC=`$PM2_CONFIG --cc`
else
...
if [ -z "$PM2_CONFIG_SOURCEABLE" ]; then
    _PM2CONFIG_BIN_DIR=`$PM2_CONFIG --bindir $PROGRAM`
    _PM2CONFIG_OBJ_DIR=`$PM2_CONFIG --objdir $PROGRAM`
    _PM2CONFIG_CPP_DIR=`$PM2_CONFIG --cppdir $PROGRAM`
    _PM2CONFIG_ASM_DIR=`$PM2_CONFIG --asmdir $PROGRAM`
    _PM2CONFIG_DEP_DIR=`$PM2_CONFIG --depdir $PROGRAM`
    _PM2CONFIG_SRC_DIR=`$PM2_CONFIG --srcdir $PROGRAM`
    _PM2CONFIG_INCLUDE_DIR=`$PM2_CONFIG --includedir $PROGRAM`
    _PM2CONFIG_STAMP_DIR=`$PM2_CONFIG --stampdir`
    _PM2CONFIG_FLAVOR_STAMP_FILE=`$PM2_CONFIG --stampfile`
    _PM2CONFIG_EXT=`$PM2_CONFIG --ext`
    _PM2CONFIG_KERNEL_CFLAGS=`$PM2_CONFIG --kernel --cflags $PROGRAM`
    _PM2CONFIG_LIBS=`$PM2_CONFIG --libs`
    _PM2CONFIG_LD_LIBS=`$PM2_CONFIG --libs-only-l`
    _PM2CONFIG_BUILD=`$PM2_CONFIG --builddir`
    _PM2CONFIG_CC=`$PM2_CONFIG --cc`
else
...
if [ -z "$PM2_CONFIG_SOURCEABLE" ]; then
    _PM2CONFIG_EXT=`$PM2_CONFIG --ext`
    _PM2CONFIG_LOADER=`$PM2_CONFIG --loader`
    _PM2CONFIG_CC=`$PM2_CONFIG --cc`
    _PM2CONFIG_CFLAGS=`$PM2_CONFIG --cflags`
    _PM2CONFIG_LIBS=`$PM2_CONFIG --libs`
    _PM2CONFIG_LD_LIBS=`$PM2_CONFIG --libs-only-l`
    _PM2CONFIG_MODULES=`$PM2_CONFIG --modules`
    _PM2CONFIG_FLAVOR_STAMP_FILE=`$PM2_CONFIG --stampfile`
    _PM2CONFIG_LIB_STAMP_FILES=`$PM2_CONFIG --stampfile all`
    _PM2CONFIG_BUILD=`$PM2_CONFIG --builddir`
fi
...
if [ -n "$PM2_CONFIG_SOURCEABLE" ]; then
    ...
    LIBRARIES="`$PM2_CONFIG --modules` common"
    destdir=$dir/mak
fi
...
if [ -z "$PM2_CONFIG_SOURCEABLE" ]; then
    _PM2CONFIG_FLAVOR_STAMP_FILE=`$PM2_CONFIG --stampfile`
    _PM2CONFIG_PROF_MODULES=`$PM2_CONFIG --profmods`
    _PM2CONFIG_HEADGEN_MODULES=`$PM2_CONFIG --headgenmods`
fi
