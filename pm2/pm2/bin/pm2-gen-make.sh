...
LIB_GEN_BIN := `$PM2_CONFIG --bindir $LIBRARY`
LIB_GEN_TMP := `$PM2_CONFIG --tmpdir $LIBRARY`
LIB_GEN_SRC := `$PM2_CONFIG --srcdir $LIBRARY`
LIB_GEN_INC := `$PM2_CONFIG --includedir $LIBRARY`
