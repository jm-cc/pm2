...
extern MARCEL_PROTECTED int ma_del_timer(struct ma_timer_list * timer);
extern MARCEL_PROTECTED int __ma_mod_timer(struct ma_timer_list *timer, unsigned long expires);
extern MARCEL_PROTECTED int ma_mod_timer(struct ma_timer_list *timer, unsigned long expires);
...
#section marcel_functions
#ifdef MA__LWPS
  extern MARCEL_PROTECTED int ma_del_timer_sync(struct ma_timer_list * timer);
#else
