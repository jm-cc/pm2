		...
		char **argv TBX_UNUSED)
{
  ...
  p_mad_service_t   service_factory = NULL;
  ...
  service_factory  = TBX_MALLOC(sizeof(mad_service_t));
  initial_service(service_factory);
  mad_store_service(madeleine,service_factory); 
