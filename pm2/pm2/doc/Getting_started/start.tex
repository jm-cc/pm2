...
\date{\footnotesize%
\url{$Id: start.tex,v 1.6 2001/04/04 17:08:34 bouge Exp $}%
}
...
\begin{warning}
  ...
  machine in the configuration. For instance, try:
\begin{shell}
ravel% rsh ravel 'ls ${PM2_ROOT}'
ravel% rsh debussy 'ls ${PM2_ROOT}'
ravel% rsh faure 'ls ${PM2_ROOT}'
\end{shell}
for each host in the current configuration. (Note the \|'|
characters!) If you do not get the list of the files in your current
\|${PM2_ROT}| directory, that is, either you get nothing or a
message like \|permission denied|, etc., then you are in trouble!
\end{warning}
