...
(\emph{École Normale Supérieure de Lyon}, France) and the \textsc{LIFL}
(\emph{Université des Sciences et Technologies de Lille}, France). 
...
\begin{table}
\caption{Supported Platform\label{tbl:platforms}}
\begin{center}
...
\end{center}
\end{table}
\paragraph{Required development tools}
...
left to the user is the underlying network selection, which is
...
demanding users. These options should be used with care. They can be
...
\paragraph{Cleanning the directory tree}
