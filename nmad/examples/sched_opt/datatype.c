...
static void index_vers_contig(void){
  ...
  if (is_server) {
    ...
    nm_so_sr_irecv(sr_if, r_gate_id, 0, buf, strlen(msg2), &request);
    ...
    nm_so_sr_isend_datatype(sr_if, gate_id, 0, &seg, &request);
...
static void index_vers_iov(void){
  ...
  if (is_server) {
    ...
    nm_so_sr_irecv_iov(sr_if, r_gate_id, 0, iov, 2, &request);
    nm_so_sr_rwait(sr_if, request);
...
static void contig_vers_index(void){
  ...
  if (is_server) {
    ...
    nm_so_sr_isend(sr_if, gate_id, 0, buf, strlen(buf), &request);
    nm_so_sr_swait(sr_if, request);
  }
...
static void iov_vers_index(void){
  ...
  if (is_server) {
    ...
    nm_so_sr_isend_iov(sr_if, gate_id, 0, iov, 2, &request);
    nm_so_sr_swait(sr_if, request);
  }
...
static void large_index_vers_contig(void){
  ...
  if (is_server) {
    ...
    nm_so_sr_irecv(sr_if, r_gate_id, 0, buf, SIZE, &request);
    nm_so_sr_rwait(sr_if, request);
...
static void large_index_vers_iov(void){
  ...
  if (is_server) {
    ...
    nm_so_sr_irecv_iov(sr_if, r_gate_id, 0, iov, 10, &request);
    nm_so_sr_rwait(sr_if, request);
...
static void large_contig_vers_index(void){
  ...
  if (is_server) {
    ...
    nm_so_sr_isend(sr_if, gate_id, 0, buf, SIZE-10, &request);
    nm_so_sr_swait(sr_if, request);
  }
...
static void large_contig_vers_index_avec_bcp_blocs(void){
  ...
  if (is_server) {
    ...
    nm_so_sr_isend(sr_if, gate_id, 0, buf, SIZE - (first_offset - 1) - (100 * nb_1KB_block), &request);
    nm_so_sr_swait(sr_if, request);
  }
...
static void iov_vers_index_avec_bcp_blocs(void){
  ...
  if (is_server) {
    ...
    nm_so_sr_isend_iov(sr_if, gate_id, 0, iov, 10, &request);
    nm_so_sr_swait(sr_if, request);
  }
