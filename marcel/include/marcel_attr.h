...
#define MARCEL_ATTR_INITIALIZER { \
  ...
  .__flags = MA_ATTR_FLAG_INHERITSCHED, \
  .__guardsize= MARCEL_STACKSGUARD, \
  .__stackaddr= NULL, \
  .__stacksize= (THREAD_SLOT_SIZE - sizeof(marcel_task_t)),	\
  .__cpuset = NULL, \
  .__cpusetsize = 0, \
...
/** PMARCEL_STACK_MIN = sizeof(marcel_task_t) + PTHREAD_STACK_MIN ~ 31300k **/
#define PMARCEL_STACK_MIN 32768
...
#ifdef MARCEL_USERSPACE_ENABLED
	unsigned user_space;
	tbx_bool_t immediate_activation;
#endif				/* MARCEL_USERSPACE_ENABLED */
#ifdef MARCEL_MIGRATION_ENABLED
...
/** Public functions **/
DEC_MARCEL(int, attr_init, (marcel_attr_t * attr) __THROW);
DEC_MARCEL(int, attr_destroy, (marcel_attr_t * attr) __THROW);
DEC_MARCEL(int, attr_setstacksize, (marcel_attr_t * attr, size_t stack) __THROW);
DEC_MARCEL(int, attr_getstacksize, (__const marcel_attr_t * __restrict attr, size_t * __restrict stack) __THROW);
DEC_MARCEL(int, attr_setstackaddr, (marcel_attr_t * attr, void *addr) __THROW);
DEC_MARCEL(int, attr_getstackaddr, (__const marcel_attr_t * __restrict attr, void **__restrict addr) __THROW);
DEC_MARCEL(int, attr_setstack, (marcel_attr_t * attr, void *stackaddr, size_t stacksize) __THROW);
DEC_MARCEL(int, attr_getstack, (__const marcel_attr_t * __restrict attr, void **__restrict stackaddr,
				size_t * __restrict stacksize) __THROW);
DEC_MARCEL(int, attr_setdetachstate, (marcel_attr_t * attr, int detached) __THROW);
DEC_MARCEL(int, attr_getdetachstate, (__const marcel_attr_t * attr, int *detached) __THROW);
...
int marcel_attr_getprio(__const marcel_attr_t * __restrict attr, int *__restrict prio);
...
DEC_MARCEL(int, attr_setinheritsched, (marcel_attr_t * attr, int inheritsched) __THROW);
DEC_MARCEL(int, attr_getinheritsched,
	   (marcel_attr_t * __restrict attr, int *__restrict inheritsched) __THROW);
DEC_MARCEL(int, attr_setscope, (marcel_attr_t * attr, int contentionscope) __THROW);
DEC_MARCEL(int, attr_getscope,
	   (__const marcel_attr_t * __restrict attr, int *contentionscope) __THROW);
DEC_MARCEL(int, attr_setschedparam,
	   (marcel_attr_t * __restrict attr,
	    __const struct marcel_sched_param * __restrict param) __THROW);
DEC_MARCEL(int, attr_getschedparam,
	   (__const marcel_attr_t * __restrict attr,
	    struct marcel_sched_param * __restrict param) __THROW);

DEC_MARCEL(int, getattr_np, (marcel_t thread, marcel_attr_t * attr) __THROW);
