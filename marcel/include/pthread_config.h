#ifndef __PTHREAD_CONFIG_H__
#define __PTHREAD_CONFIG_H__
...
#define	__LINUX_KERNEL_VERSION (2 * 65536 + 2 * 256 + 0)

/* Override abi-tags ABI version if necessary.  */
#define  __ABI_TAG_VERSION 2,2,0
