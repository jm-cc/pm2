...
PM2_MARCEL_CFLAGS_KERNEL="$PM2_MARCEL_CFLAGS_KERNEL -D_POSIX_C_SOURCE=200112 -D_GNU_SOURCE"

case "$PM2_SYS" in
    SOLARIS_SYS)
    	PM2_MARCEL_CFLAGS_KERNEL="$PM2_MARCEL_CFLAGS_KERNEL -D_XOPEN_SOURCE=500"
	;;                                                 
    *)                                                     
