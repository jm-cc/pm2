...
struct timeval mainstart, mainfinish;
...
any_t run(any_t foo) {
	...
	{
		case 1:
			bulle[1] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 2);
			bulle[11] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 1);
			memset((void*) bulle[1], 0, MEMSIZE);
			memset((void*) bulle[11], 0, MEMSIZE);
			break;
		case 11:
			bulle[12] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 1);
			memset((void*) bulle[12], 0, MEMSIZE);
			break;
		case 17:
			bulle[13] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 1);
			memset((void*) bulle[13], 0, MEMSIZE);
			break;
		case 21:
			bulle[2] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 2);
			memset((void*) bulle[2], 0, MEMSIZE);
			bulle[21] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 1);
			memset((void*) bulle[21], 0, MEMSIZE);
			break;
		case 29:
			bulle[22] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 1);
			memset((void*) bulle[22], 0, MEMSIZE);
			break;
		case 37:
			bulle[3] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 2);
			bulle[31] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 1);
			memset((void*) bulle[3], 0, MEMSIZE);
			memset((void*) bulle[31], 0, MEMSIZE);
			break;
		case 45:
			bulle[32] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 1);
			memset((void*) bulle[32], 0, MEMSIZE);
			break;
		case 49:
			bulle[4] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 2);
			bulle[41] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 1);
			memset((void*) bulle[4], 0, MEMSIZE);
			memset((void*) bulle[41], 0, MEMSIZE);
			break;
		case 53:
			bulle[42] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 1);
			memset((void*) bulle[42], 0, MEMSIZE);
			break;
		case 57:
			bulle[5] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 2);
			bulle[51] = ( char *) marcel_malloc_customized(MEMSIZE, HIGH_WEIGHT, 1, -1, 1);
			memset((void*) bulle[5], 0, MEMSIZE);
			memset((void*) bulle[51], 0, MEMSIZE);
			break;
	}
	...
	/* attendre que la bulle soit reveillee */
   ...
   /* liberation memoire */
	...
	{
		marcel_free_customized(bulle[1]);
		marcel_free_customized(bulle[11]);
		marcel_free_customized(bulle[12]);
		marcel_free_customized(bulle[13]);
		marcel_free_customized(bulle[2]);
		marcel_free_customized(bulle[21]);
		marcel_free_customized(bulle[22]);
		marcel_free_customized(bulle[3]);
		marcel_free_customized(bulle[31]);
		marcel_free_customized(bulle[32]);
		marcel_free_customized(bulle[4]);
		marcel_free_customized(bulle[41]);
		marcel_free_customized(bulle[42]);
		marcel_free_customized(bulle[5]);
		marcel_free_customized(bulle[51]);
...
int main(int argc, char *argv[]) 
{
   ...
   marcel_bubble_init(&b5);
	...
	marcel_bubble_insertentity(&b0, &b3.as_entity);
	marcel_bubble_insertentity(&b0, &b4.as_entity);
	marcel_bubble_insertentity(&b0, &b5.as_entity);

	marcel_bubble_insertentity(&b1, &b11.as_entity);
	marcel_bubble_insertentity(&b1, &b12.as_entity);
	marcel_bubble_insertentity(&b1, &b13.as_entity);

	marcel_bubble_insertentity(&b2, &b21.as_entity);
	marcel_bubble_insertentity(&b2, &b22.as_entity);

	marcel_bubble_insertentity(&b3, &b31.as_entity);
	marcel_bubble_insertentity(&b3, &b32.as_entity);

	marcel_bubble_insertentity(&b4, &b41.as_entity);
	marcel_bubble_insertentity(&b4, &b42.as_entity);

	marcel_bubble_insertentity(&b5, &b51.as_entity);

   /* lancement des threads pour allouer */
   {
		marcel_attr_t attr;
      marcel_attr_init(&attr);
      marcel_attr_setnaturalbubble(&attr, &b11);
...

   {
...

	{
		marcel_attr_t attr;
      marcel_attr_init(&attr);
      marcel_attr_setnaturalbubble(&attr, &b12);
      marcel_attr_setid(&attr,0);
      marcel_attr_setprio(&attr,0);
      marcel_attr_setname(&attr,"thread");
...

   {
		marcel_attr_t attr;
      marcel_attr_init(&attr);
      marcel_attr_setnaturalbubble(&attr, &b13);
      marcel_attr_setid(&attr,0);
      marcel_attr_setprio(&attr,0);
      marcel_attr_setname(&attr,"thread");
...

   {
...

	{
		marcel_attr_t attr;
      marcel_attr_init(&attr);
      marcel_attr_setnaturalbubble(&attr, &b21);
      marcel_attr_setid(&attr,0);
      marcel_attr_setprio(&attr,0);
      marcel_attr_setname(&attr,"thread");
...

   {
...

	{
		marcel_attr_t attr;
      marcel_attr_init(&attr);
      marcel_attr_setnaturalbubble(&attr, &b22);
      marcel_attr_setid(&attr,0);
      marcel_attr_setprio(&attr,0);
      marcel_attr_setname(&attr,"thread");
...

   {
...

	{
		marcel_attr_t attr;
      marcel_attr_init(&attr);
      marcel_attr_setnaturalbubble(&attr, &b31);
      marcel_attr_setid(&attr,0);
      marcel_attr_setprio(&attr,0);
      marcel_attr_setname(&attr,"thread");
...

   {
...

	{
		marcel_attr_t attr;
      marcel_attr_init(&attr);
      marcel_attr_setnaturalbubble(&attr, &b32);
      marcel_attr_setid(&attr,0);
      marcel_attr_setprio(&attr,0);
      marcel_attr_setname(&attr,"thread");
...

   {
		marcel_attr_t attr;
      marcel_attr_init(&attr);
      marcel_attr_setnaturalbubble(&attr, &b41);
      marcel_attr_setid(&attr,0);
      marcel_attr_setprio(&attr,0);
      marcel_attr_setname(&attr,"thread");
...

   {
...

	{
		marcel_attr_t attr;
      marcel_attr_init(&attr);
      marcel_attr_setnaturalbubble(&attr, &b42);
      marcel_attr_setid(&attr,0);
      marcel_attr_setprio(&attr,0);
      marcel_attr_setname(&attr,"thread");
...

   {
 ...
 
	{
		marcel_attr_t attr;
      marcel_attr_init(&attr);
      marcel_attr_setnaturalbubble(&attr, &b51);
      marcel_attr_setid(&attr,0);
      marcel_attr_setprio(&attr,0);
      marcel_attr_setname(&attr,"thread");
