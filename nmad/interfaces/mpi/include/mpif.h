...
! for consistency, C and FORTRAN types are defined
      ...
      INTEGER MPI_INTEGER
      PARAMETER (MPI_INTEGER=22)
      INTEGER MPI_INTEGER4
      PARAMETER (MPI_INTEGER4=23)
      INTEGER MPI_INTEGER8
      PARAMETER (MPI_INTEGER8=24)
      INTEGER MPI_COMPLEX
      PARAMETER (MPI_COMPLEX=25)
      INTEGER MPI_DOUBLE_COMPLEX
      PARAMETER (MPI_DOUBLE_COMPLEX=26)
      INTEGER MPI_PACKED
      PARAMETER (MPI_PACKED=27)

      INTEGER MPI_LONG_INT
      PARAMETER (MPI_LONG_INT=28)
      INTEGER MPI_SHORT_INT
      PARAMETER (MPI_SHORT_INT=29)
      INTEGER MPI_FLOAT_INT
      PARAMETER (MPI_FLOAT_INT=30)
      INTEGER MPI_DOUBLE_INT
      PARAMETER (MPI_DOUBLE_INT=31)
      INTEGER MPI_LONG_DOUBLE_INT
      PARAMETER (MPI_LONG_DOUBLE_INT=32)

      INTEGER MPI_2INT
      PARAMETER (MPI_2INT=33)
      INTEGER MPI_2INTEGER
      PARAMETER (MPI_2INTEGER=34)
      INTEGER MPI_2REAL
      PARAMETER (MPI_2REAL=35)
      INTEGER MPI_2DOUBLE_PRECISION
      PARAMETER (MPI_2DOUBLE_PRECISION=36)
