...
int main(int argc, char *argv[]) {
   ...
   marcel_bubble_init(&b5);
	...
	marcel_bubble_insertentity(&b1, &b5.as_entity);

	marcel_bubble_insertentity(&b2, &b6.as_entity);
	marcel_bubble_insertentity(&b2, &b7.as_entity);

	marcel_bubble_insertentity(&b3, &b8.as_entity);
	marcel_bubble_insertentity(&b3, &b9.as_entity);
...

   {
...

	{
		marcel_attr_t attr;
      marcel_attr_init(&attr);
      marcel_attr_setnaturalbubble(&attr, &b8);
      marcel_attr_setid(&attr,0);
      marcel_attr_setprio(&attr,0);
      marcel_attr_setname(&attr,"thread");
...

   {
		marcel_attr_t attr;
      marcel_attr_init(&attr);
      marcel_attr_setnaturalbubble(&attr, &b9);
      marcel_attr_setid(&attr,0);
      marcel_attr_setprio(&attr,0);
      marcel_attr_setname(&attr,"thread");
...

   {
	...
	marcel_see_bubble(&b0, 0, 0);
	//marcel_bubble_badspread(&b0, marcel_topo_level(0,0));
