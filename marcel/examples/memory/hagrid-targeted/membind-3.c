 ...
 * memory, previously bound to the node the first thread is running
 * on. The second thread location is user defined. */
...
main (int argc, char **argv) 
{
  ...
  if (argc < 2) {
    fprintf (stderr, "Usage: ./membind-3 <node> (where node is the node you want to put the second thread on.)\n");
    return 0;
  }
