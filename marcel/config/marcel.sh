...
PM2_MARCEL_CFLAGS="$PM2_MARCEL_CFLAGS -I${PM2_ROOT}/marcel/autogen-include -D__STDC_LIMIT_MACROS -D_POSIX_C_SOURCE=200112 -D_GNU_SOURCE"

case "$PM2_SYS" in
    SOLARIS_SYS)
    	PM2_MARCEL_CFLAGS="$PM2_MARCEL_CFLAGS -D_XOPEN_SOURCE=500"
	;;
    *)
    	PM2_MARCEL_CFLAGS="$PM2_MARCEL_CFLAGS -D_XOPEN_SOURCE=600"
	;;
esac
