...
#ifndef __SYS_LINUX_TIMER_H__
#define __SYS_LINUX_TIMER_H__
...
/** Public functions **/
extern int marcel_init_timer(struct marcel_timer_list *timer, void (*function)(unsigned long id), 
