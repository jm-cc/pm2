...
void large_contigu_vers_large_contigu(void){
  ...
  if (is_server) {
    ...
    nm_so_sr_irecv_iov(sr_if, NM_SO_ANY_SRC, 0, iov, 1, &request);
...
void large_contigu_vers_large_disperse(void){
  ...
  if (is_server) {
    ...
    nm_so_sr_irecv_iov(sr_if, NM_SO_ANY_SRC, 0, iov, 3, &request);
    nm_so_sr_rwait(sr_if, request);
...
void large_disperse_vers_large_disperse_disymetrique(void){
  ...
  if (is_server) {
    ...
    nm_so_sr_irecv_iov(sr_if, NM_SO_ANY_SRC, 0, iov, 2, &request);
    nm_so_sr_rwait(sr_if, request);
