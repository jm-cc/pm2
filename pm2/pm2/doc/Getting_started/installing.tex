...
\stamp $Id: installing.tex,v 1.2 2001/04/12 16:00:58 bouge Exp $
...
\begin{shell}
ravel% setenv PM2_HOME          ${HOME}
ravel% setenv PM2_ROOT          ${PM2_HOME}/pm2
ravel% setenv PATH              ${PATH}:${PM2_ROOT}/bin
ravel% setenv PM2_BUILD_DIR     ${PM2_HOME}/build  
\end{shell}
