...
#ifndef __INLINEFUNCTIONS_ASM_PPC_MARCEL_COMPAREEXCHANGE_H__
#define __INLINEFUNCTIONS_ASM_PPC_MARCEL_COMPAREEXCHANGE_H__
							...
							unsigned long repl, int size)
{
	...
	if (size == 4) {
		...
		__asm__ __volatile__(TBX_LOCAL_LBL(1) ":\n"
				     "      lwarx %0,0,%2;\n"
				     "      cmpw 0,%0,%3;\n"
...
#endif /** __INLINEFUNCTIONS_ASM_PPC_MARCEL_COMPAREEXCHANGE_H__ **/
