...
nm_gm_extract_info(char			 *trk_url,
 ...
 error:
        NM_FATAL("mad_gm_extract_info failed");
}
...
nm_gm_open_track		(struct nm_trk_rq	*p_trk_rq) {
 ...
 error:
        NM_FATAL("nm_gm_open_trk failed");
}
