...
static int nm_sisci_load(void)
{
  puk_component_declare("NewMad_Driver_sisci",
			puk_component_provides("PadicoAdapter", "adapter", &nm_sisci_adapter_driver),
			puk_component_provides("NewMad_Driver", "driver", &nm_sisci_driver));

  return 0;
}
PADICO_MODULE_BUILTIN(NewMad_Driver_sisci, &nm_sisci_load, NULL, NULL);
