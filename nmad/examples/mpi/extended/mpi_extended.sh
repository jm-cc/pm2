...
mv mpi_extended mpi_extended_$ARCH
../mpirun -machinefile results/${machines}_${protocol}/machines.lst -np $nb_machines mpi_extended_$ARCH > results/${machines}_${protocol}/result_extended_${machines}_${protocol}.txt 2>&1
...
#plot "result_extended_${machines}_${protocol}_chunk$chunk.txt" using 3:6 with linespoints title "Struct datatype", "result_extended_${machines}_${protocol}_chunk$chunk.txt" using 3:7 with linespoints title "Extended", "result_extended_${machines}_${protocol}_chunk$chunk.txt" using 3:9 with linespoints title "Isend"

#set ylabel "Benefit"
#set output "result_extended_${machines}_${protocol}_chunk${chunk}_benefit.png"
#plot "result_extended_${machines}_${protocol}_chunk$chunk.txt" using 3:8 with linespoints title "Extended", "result_extended_${machines}_${protocol}_chunk$chunk.txt" using 3:10 with linespoints title "Isend"
