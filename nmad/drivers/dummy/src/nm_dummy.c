...
/* ***************************************** */
extern int nm_dummy_load(){
  puk_adapter_declare("NewMad_Driver_dummy",
		      puk_adapter_provides("PadicoAdapter", &nm_dummy_adapter_driver),
		      puk_adapter_provides("NewMad_Driver", &nm_dummy_driver));
