...
#ifndef __SYS_MARCEL_ALIAS_H__
#define __SYS_MARCEL_ALIAS_H__
...
#define __SYS_LIBC_NAME(symbol) PREFIX_SYMBOL(symbol,, __)
...
/* Declare pmarcel_name */
#define DEC_PMARCEL(rtype, name, proto)		\
	extern rtype PMARCEL_NAME(name) proto

/* Declare lpt_name */
#ifdef MA__LIBPTHREAD
#define DEC_LPT(rtype, name, proto) \
	extern rtype LPT_NAME(name) proto;
#else
#define DEC_LPT(rtype, name, proto)
#endif
...
#define DEF_MARCEL_PMARCEL_VAARGS(rtype, name, proto, code)		\
	DEF_MARCEL(rtype, name, proto, , code)				\
	DEF_PMARCEL(rtype, name, proto, , code)
...
#define DEF___C_STRONG(rtype, name, proto, args)			\
	extern __typeof__(PMARCEL_NAME(name)) __SYS_LIBC_NAME(name);	\
	DEF_STRONG_T(rtype, PMARCEL_NAME(name), __SYS_LIBC_NAME(name), proto, args)
/* Define a weak __alias name -> pmarcel_name */
#define DEF___C_WEAK(rtype, name, proto, args)				\
	extern __typeof__(PMARCEL_NAME(name)) __SYS_LIBC_NAME(name);	\
	DEF_WEAK_T(rtype, PMARCEL_NAME(name), __SYS_LIBC_NAME(name), proto, args)
#else
#define DEF_C_STRONG(rtype, name, proto, args)
#define DEF_C_WEAK(rtype, name, proto, args)
#define DEF___C_STRONG(rtype, name, proto, args)
...
#define DEF___LIBC_STRONG(rtype, name, proto, args)			\
	extern __typeof__(LPT_NAME(name)) __SYS_LIBC_NAME(name);		\
	DEF_STRONG_T(rtype, LPT_NAME(name), __SYS_LIBC_NAME(name), proto, args)
/* Define a weak alias __name -> lpt_name */
#define DEF___LIBC_WEAK(rtype, name, proto, args)			\
	extern __typeof__(LPT_NAME(name)) __SYS_LIBC_NAME(name);		\
	DEF_WEAK_T(rtype, LPT_NAME(name), __SYS_LIBC_NAME(name), proto, args)
#else
#define DEF_LIBC_STRONG(rtype, name, proto, args)
#define DEF_LIBC_WEAK(rtype, name, proto, args)
#define DEF___LIBC_STRONG(rtype, name, proto, args)
