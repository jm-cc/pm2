...
#warning "This file can't be used if Marcel is not configured with --with-libtype=pmarcel"
#endif
...
#define PTHREAD_KEYS_MAX PMARCEL_KEYS_MAX
...
#undef CPU_ZERO_S
#define CPU_ZERO_S(cpu, setsize, cpusetp) PMARCEL_CPU_ZERO_S(setsize, cpusetp)
#undef CPU_COUNT_S
