...
/** Public macros **/
#define MARCEL_GET_TASK_MEMORY_AREAS(task) ((&(task)->as_entity)->memory_areas)
#define MARCEL_GET_TASK_MEMORY_AREAS_LOCK(task) ((&(task)->as_entity)->memory_areas_lock)
#define MARCEL_GET_BUBBLE_MEMORY_AREAS(bubble) ((&(bubble)->as_entity)->memory_areas)
#define MARCEL_GET_BUBBLE_MEMORY_AREAS_LOCK(bubble) ((&(bubble)->as_entity)->memory_areas_lock)
...
#define MA_SCHED_ENTITY_INITIALIZER(e,t,p,n) {				\
      .type = t,							\
...
#define MA_HOLDER_INITIALIZER(h, t, n) {			       \
      .type = t,						       \
      .name = n,						       \
