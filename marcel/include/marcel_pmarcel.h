...
extern pmarcel_t pmarcel_self(void)
__THROW TBX_CONST;
...
extern int pmarcel_attr_init(pmarcel_attr_t * __attr)
...
extern int pmarcel_attr_setdetachstate(pmarcel_attr_t * __attr, int __detachstate)
__THROW __tbx_attribute_nonnull__((1));
...
extern int pmarcel_attr_setguardsize(pmarcel_attr_t * __attr, size_t __guardsize)
__THROW __tbx_attribute_nonnull__((1));
...
extern int pmarcel_attr_setinheritsched(pmarcel_attr_t * __attr, int __inherit)
__THROW __tbx_attribute_nonnull__((1));
...
extern int pmarcel_attr_setstackaddr(pmarcel_attr_t * __attr, void *__stackaddr)
...
extern int pmarcel_attr_setstacksize(pmarcel_attr_t * __attr, size_t __stacksize)
__THROW __tbx_attribute_nonnull__((1));
...
extern int pmarcel_attr_getaffinity_np(__const pmarcel_attr_t * __attr,
				       size_t __cpusetsize, pmarcel_cpu_set_t * __cpuset)
__THROW __tbx_attribute_nonnull__((1, 3));
...
extern int pmarcel_setschedprio(pmarcel_t __target_thread, int __prio) __THROW;
...
extern int pmarcel_rwlock_init(pmarcel_rwlock_t * __restrict __rwlock,
			       __const pmarcel_rwlockattr_t * __restrict __attr)
__THROW __tbx_attribute_nonnull__((1));
...
extern int pmarcel_rwlockattr_setpshared(pmarcel_rwlockattr_t * __attr, int __pshared)
__THROW __tbx_attribute_nonnull__((1));

/* Return current setting of reader/writer preference.  */
extern int pmarcel_rwlockattr_getkind_np(__const pmarcel_rwlockattr_t *
					 __restrict __attr, int *__restrict __pref)
__THROW __tbx_attribute_nonnull__((1, 2));
...
extern int pmarcel_key_create(pmarcel_key_t * __key, void (*__destr_function) (void *))
__THROW __tbx_attribute_nonnull__((1));
...
extern int pmarcel_setspecific(pmarcel_key_t __key, __const void *__pointer) __THROW;
...
extern int pmarcel_getcpuclockid(pmarcel_t __thread_id, clockid_t * __clock_id)
__THROW __tbx_attribute_nonnull__((2));
#  endif
#endif
...
extern int pmarcel_atfork(void (*__prepare) (void),
			  void (*__parent) (void), void (*__child) (void)) __THROW;

/***************************autres fonctions**************************/
extern int pmarcel_mutexattr_getprioceiling(__const pmarcel_mutexattr_t *
					    __restrict attr,
					    int *__restrict prioceiling) __THROW;
extern int pmarcel_mutexattr_setprioceiling(pmarcel_mutexattr_t * attr,
					    int prioceiling) __THROW;
extern int pmarcel_mutexattr_getprotocol(__const pmarcel_mutexattr_t * __restrict attr,
					 int *__restrict protocol);
extern int pmarcel_mutexattr_setprotocol(pmarcel_mutexattr_t * attr, int protocol);

#ifdef _POSIX_CPUTIME
#  if _POSIX_CPUTIME >= 0
extern int pmarcel_condattr_getclock(__const pmarcel_condattr_t * __restrict attr,
				     clockid_t * __restrict clock_id);
extern int pmarcel_condattr_setclock(pmarcel_condattr_t * attr, clockid_t clock_id);
#  endif
#endif
